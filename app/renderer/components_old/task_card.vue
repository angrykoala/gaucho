<template>
    <li class="run-card task-card">
        <div :class="{ 'edit-mode': editMode}" class="collapsible-header row unselectable-text">
            <div v-if="editMode" class="col s1">
                <i class="tiny material-icons">drag_handle</i>
            </div>
            <div :class="{ s4: editMode, s5: !editMode }" class="col">
                <strong class="truncate">{{task.title}}</strong>
            </div>
            <div class="col s3">
                <div v-if="$store.state.userConfig.showTimer" class="truncate task-time">{{executionTime}}</div>
            </div>
            <div class="col s3">
            ...
            <div class="col s1">
                ...
                <i v-else :style="{color: statusColor}" class="small material-icons">{{task.status}}</i>
