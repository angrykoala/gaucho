...
module.exports = {
    ...
    template: `
        <div v-bind:id="id" class="no-margin">
            ...
            <draggable v-show="suite.tasks.length > 0 || AppStatus.editMode" class="collapsible task-list" data-collapsible="accordion" element="ul" :options="{draggable:'.task-card', handle: '.collapsible-header'}" v-model="draggableTasks" @end="restructureTasks" :move="checkMove">
