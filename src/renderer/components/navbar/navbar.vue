...
<nav class="navbar is-fixed-top" role="navigation" aria-label="main navigation">
    <div class="navbar-brand">
        <div class="navbar-item is-unselectable">
            <img class="logo-icon" src="../../../../resources/logos/gaucho_logo.svg">
...
import UpdateMessage from "./update_message.vue";
import SuiteTabs from "./suite_tabs.vue";
import NavbarMenu from "./navbar_menu.vue";

export default defineComponent({
    components: {
        "update-message": UpdateMessage,
        "suite-tabs": SuiteTabs,
